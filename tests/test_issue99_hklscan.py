...
class Issue99(unittest.TestCase):
    ...
    def test_specplot_lmn40_scan64(self):
        ...
        self.assertTrue(
            issubclass(image_maker, spec2nexus.specplot.ImageMaker)
        )

        plotter = image_maker()
        self.assertTrue(
            isinstance(plotter, spec2nexus.specplot.HKLScanPlotter)
        )
        ...
        self.assertTrue(
            plotter.plot_subtitle().startswith("#" + str(scan_number))
        )
