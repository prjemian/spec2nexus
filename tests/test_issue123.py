...
class Issue123(unittest.TestCase):
    ...
    def test_spock_file(self):
        ...
        self.assertEqual(
            len(specData.headers), 1, "expected number of headers"
        )
        ...
        self.assertEqual(
            len(header.comments), 0, "expected number of header comments"
        )
        ...
        self.assertEqual(
            len(header.O), 20, "defined positioner label rows"
        )
        ...
        self.assertEqual(
            len(d1), 51, "data 'Pt_No' has expected number of values"
        )
        self.assertEqual(
            scan.scanCmd, "dscan th -0.5 0.5 50 1.0", "scan command"
        )
    ...
    def test_33id_file(self):
        ...
        self.assertEqual(
            len(header.comments), 1, "expected number of header comments"
        )
