# -*- coding: utf-8 -*-
#
# spec2nexus documentation build configuration file, created by
...
htmlhelp_basename = 'spec2nexusdoc'
...
latex_documents = [
  ('index', 
   spec2nexus.__package_name__+'.tex', 
   spec2nexus.__package_name__+u' Documentation',
   spec2nexus.__author__, 
   'manual'),
]
